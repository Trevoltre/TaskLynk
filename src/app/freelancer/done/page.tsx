    ...
    <div className="px-4 md:px-6 lg:px-8 py-6">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground">
          Review orders you've completed and submitted for review. Await admin or client confirmation.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Done Orders</CardTitle>
      ...
      {loadingJobs ? (
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground">No done orders</p>
          </CardContent>
        </Card>
      ) : (
